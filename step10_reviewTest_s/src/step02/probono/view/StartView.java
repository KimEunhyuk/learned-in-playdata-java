...
public class StartView {
	...
	public static void main(String[] args) {
		...
		TalentDonationProject audreyHepbunProject = new TalentDonationProject("02오드리햅번", donator2, beneficiary2, audreyHepbun, "2020-03-31", "2020-04-03", "예술가와의 만남");
		...
		controller.donationProjectUpdate("01슈바이처", donator4);//갱신 + 검색

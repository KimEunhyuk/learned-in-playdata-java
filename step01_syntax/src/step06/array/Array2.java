// arter + shift + r = 어디에나 있는 해당변수이름 변경시 모두 바꿔줌
// 변수, 메소드 명 수정시 호출한 곳까지 동시에 변경하기 위한 단축키
//step02.Person 배열 활용
...
//		Person[] i = {1, 2, 3}; // Person 배열 타입의 변수
	...
	public static void printArrayForEach(Person[] v) {
		for(Person i : v) {//i는 배여르이 각 요소의 데이터를 보유받게 되는 변수

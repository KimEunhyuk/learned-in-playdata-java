...
public class Exception2 {
	...
	public static void m3() {
		try { //로직 단 예외 발생 가능성있는 코드 블록
			...
			Class.forName("step04.exception.B"); //문제 발생 가능성 있는 라인
	...
	//예외 발생해서 직접 호출한 곳으로 throws 해 보기
	//m4() 호출한 곳에서 예외 처리
	...
	public static void m4(String v) throws Exception{
		...
		if(!v.equals("playdata")) {//playdata가 아닌 경우만 true가 되는 조건식

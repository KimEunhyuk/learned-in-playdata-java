...
public class L02Method {
	...
	//생성자 용도 - 객체라는 것을 만들때 필수로 사용되는 요소
	...
	// 하나의 정수값 반환 int / return int값
	int sum(int v1, int v2) {
		return v1 + v2;
	}
	
	//result의 변수는 사실상 선언될 의미가 어차피 반환로직으로 한번만 사용될 것이기 때문에 불필요
	...
	//java L02Method <- (java Program) 
	//실행 요청시 해당 클래스의 main메소드를 jre에서 자동 호출
	//main() 제외한 우리가 개발한 모든 메소드(기능)들은 직접 코드로 호출
	public static void main(String[] args) {
		...
		System.out.println(l);		//step01.basic.L02Method@123a439b
		int r = l.sum(10, 20); 		// int sum(int v1, int v2)
		System.out.println("결과 - " + r); // 결과 - 30

...
//	private TalentDonationProject[] donationProjectList = new TalentDonationProject[10];
	private ArrayList<TalentDonationProject> donationProjectList
	= new ArrayList<TalentDonationProject>();
	...
	public ArrayList<TalentDonationProject> getDonationProjectsList() {
		//TalentDonationProject[] -> ArrayList<TalentDonationProject>
	...
	public void donationProjectInsert(TalentDonationProject project) {
		for(TalentDonationProject tdp: donationProjectList) {
			if(tdp != null) {
...
//		for(TalentDonationProject project : donationProjectList) {
//			if(project != null && project.getTalentDonationProjectName().equals(projectName)) {
//				project.setTalentDonationProjectName(projectName);
//				break;
//			}
//		}
		...
		for(int i=0; i<count ; i++) {
			...
			if(project != null && project.getTalentDonationProjectName().equals(projectName)) {
				donationProjectList.set(i, null);//참조했던 객체를 쓰레기로 만들고 null로 대입해서 배열에서 삭제
